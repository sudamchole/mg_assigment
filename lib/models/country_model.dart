...
class CountryModel {
  ...
  CountryModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['borders'] != null) {
      borders = new List<Null>();
      json['borders'].forEach((v) {
        //borders.add(new Null.fromJson(v));
      });
    }
...
class RegionalBlocs {
  String acronym;
  String name;
  List<Null> otherAcronyms;
  List<Null> otherNames;
